use super::dto::{CreateFile, UpdateFile, UploadedFileDto};
use super::model::FileType;
use super::queries::FileRepo;
...
impl FileService {
    ...
    /// Retrieves the metadata of a file by user id.
    ...
    /// Builds the file path for the uploaded file.
    ...
    pub async fn delete_file(&self, file_id: String) -> Result<String, AppError> {
...
/// Validates the file upload by checking its size, name, and extension.
