...
use super::queries::UserAuthRepo;
use super::{dto::AuthUserDto, repository::UserAuthRepository};
use crate::common::{
    error::AppError,
    hash_util,
...
impl AuthService {
    ...
    pub async fn create_user_auth(&self, auth_user: AuthUserDto) -> Result<(), AppError> {
    ...
    pub async fn login_user(&self, auth_payload: AuthPayload) -> Result<AuthBody, AppError> {
